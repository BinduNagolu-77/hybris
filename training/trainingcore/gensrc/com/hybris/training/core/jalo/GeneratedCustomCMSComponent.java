...
/**
 * Generated class for type {@link com.hybris.training.core.jalo.CustomCMSComponent CustomCMSComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedCustomCMSComponent extends SimpleCMSComponent
{
	/** Qualifier of the <code>CustomCMSComponent.headrerText</code> attribute **/
	public static final String HEADRERTEXT = "headrerText";
	/** Qualifier of the <code>CustomCMSComponent.footerText</code> attribute **/
	public static final String FOOTERTEXT = "footerText";
	/** Qualifier of the <code>CustomCMSComponent.offerImage</code> attribute **/
	public static final String OFFERIMAGE = "offerImage";
	/** Qualifier of the <code>CustomCMSComponent.offerImageLink</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomCMSComponent.footerText</code> attribute.
	...
	public String getFooterText(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedCustomCMSComponent.getFooterText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomCMSComponent.footerText</code> attribute. 
	...
	public void setFooterText(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedCustomCMSComponent.setFooterText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomCMSComponent.headrerText</code> attribute.
	...
	public String getHeadrerText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedCustomCMSComponent.getHeadrerText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomCMSComponent.headrerText</code> attribute. 
	...
	public void setHeadrerText(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedCustomCMSComponent.setHeadrerText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomCMSComponent.offerImage</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomCMSComponent.offerImage</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CustomCMSComponent.offerImageLink</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CustomCMSComponent.offerImageLink</code> attribute. 
